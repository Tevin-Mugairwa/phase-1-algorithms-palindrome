...
/* 
  Add your pseudocode here
    Function isPalindrome has to take a string as a parements. 
    If the string is palindrom, the function should retur true. 
    If not then the function should return false
*/

/*
  Add written explanation of your solution here
  The function takes the word and splits each letter into an array, 
  then the array is reversed. The array is then joined again into a word. 
